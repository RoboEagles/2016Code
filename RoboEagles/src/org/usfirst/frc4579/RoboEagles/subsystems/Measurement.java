...
public class Measurement extends Subsystem {
    ...
    private final MotorMonitor loaderMotorMonitor = new MotorMonitor(13, null);
    private double loaderMotorSpeed;
    ...
    public void measure() {
    	...
    	loaderMotorSpeed = loaderMotorMonitor.getSpeed();
    	
    }
    
    public double getLoaderCurrent() {
    	return loaderMotorSpeed;
    }
