...
public class Lifter extends PIDSubsystem {
    ...
    private final Solenoid lifterArmExtension = RobotMap.lifterlifterArmExtension;
    private final DigitalInput topLimit = RobotMap.liftertopLimit;
    private final DigitalInput bottomLimit = RobotMap.lifterbottomLimit;
    ...
    protected void usePIDOutput(double output) {
    	...
    	System.out.println("PID: " + -output + " | Setpoint: " + getSetpoint() + " | POT: " + lifterPotentiometer.pidGet());
    ...
    public void extendArm() {
    	if(isArmed()) {
    		lifterArmExtension.set(true);
    	}
    }
    
    public void retractArm() {
    	lifterArmExtension.set(false);
    }
